...
final class IncrementalCompilationTests: XCTestCase {
  ...
  func testIncremental() throws {
    try withTemporaryDirectory { path in
      ...
      let inputBaseNames = inputPathsAndContents
        .map {$0.0.basename}
        .sorted()
        .joined(separator: ", ")
      ...
      try! doABuild("initial", expectingRemarks: [
        "incremental compilation could not read build record at \(derivedDataPath.appending(component: "theModule-master.swiftdeps")): The operation couldn’t be completed. (TSCBasic.FileSystemError error 3.).",
        "Found \(inputPathsAndContents.count) batchable jobs",
        "Forming into 1 batch",
        "Forming batch job from 2 constituents: main.swift, other.swift",
      ]
      + ["Starting", "Finished"].map {"\($0) Compiling \(inputBaseNames)"}
      + ["Starting", "Finished"].map {"\($0) Linking \(module)" }
      )
      #if true
      try! doABuild("no-change", expectingRemarks: [
        "Incremental compilation decision: main.swift is current; skipping",
        "Incremental compilation decision: other.swift is current; skipping",
        "Incremental compilation decision: Skipping: {compile: main.o <= main.swift}",
        "Incremental compilation decision: Skipping: {compile: other.o <= other.swift}",
        "Incremental compilation decision: Skipping Compiling main.swift",
        ...
        "Incremental compilation decision: Scheduling for 2nd wave Linking theModule",
      ...
      try! doABuild("non-propagating", expectingRemarks: [
        "Incremental compilation decision: main.swift is current; skipping",
        "Incremental compilation decision: other.swift has changed; scheduling",
        "Incremental compilation decision: Queuing (initial): {compile: other.o <= other.swift}",
        "Incremental compilation decision: not scheduling dependents of other.swift; unknown changes",
        "Incremental compilation decision: Skipping: {compile: main.o <= main.swift}",
        "Incremental compilation decision: Skipping Compiling main.swift",
        "Incremental compilation decision: Delaying Linking theModule pending discovering delayed dependencies",
        "Incremental compilation decision: Scheduling for 2nd wave Linking theModule",
      ...
      try! doABuild("propagating into 2nd wave", expectingRemarks: [
        "Incremental compilation decision: other.swift is current; skipping",
        "Incremental compilation decision: main.swift has changed; scheduling",
        "Incremental compilation decision: Queuing (initial): {compile: main.o <= main.swift}",
        "Incremental compilation decision: not scheduling dependents of main.swift; unknown changes",
        "Incremental compilation decision: Skipping: {compile: other.o <= other.swift}",
        "Incremental compilation decision: Skipping Compiling other.swift",
        "Incremental compilation decision: Delaying Linking theModule pending discovering delayed dependencies",
        "Incremental compilation decision: Scheduling for 2nd wave Linking theModule",
        ...
        "Incremental compilation decision: Scheduling for 2nd wave Compiling other.swift",
        "Found 1 batchable job",
        "Forming into 1 batch",
        "Forming batch job from 1 constituents: other.swift",
        "Starting Compiling other.swift",
