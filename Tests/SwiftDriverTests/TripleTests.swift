...
@Suite struct TripleTests {
  ...
  @Test func toolchainSelection() {
    ...
    assertToolchain("wasm32-unknown-wasi", WASIToolchain.self)
    assertToolchain("wasm64-unknown-unknown", None.self)
    assertToolchain("wasm64-unknown-wasi", WASIToolchain.self)
    assertToolchain("wasm32-unknown-emscripten", EmscriptenToolchain.self)
    assertToolchain("wasm64-unknown-emscripten", EmscriptenToolchain.self)
