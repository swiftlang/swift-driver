...
extension Option {
  ...
  public static let swiftVersion: Option = Option("-swift-version", .separate, alias: Option.languageMode, attributes: [.frontend, .synthesizeInterface, .moduleInterface], metaVar: "<vers>", helpText: "Interpret input according to a specific Swift language version number")
