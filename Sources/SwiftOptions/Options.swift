...
extension Option {
  ...
  public static let clangTarget: Option = Option("-clang-target", .separate, attributes: [.frontend, .symbolGraphExtract], helpText: "Separately set the target we should use for internal Clang instance")
  ...
  public static let enableClangSpi: Option = Option("-enable-clang-spi", .flag, attributes: [.frontend, .noDriver], helpText: "Import Clang SPIs as Swift SPIs")
  ...
  public static let experimentalEmitModuleSeparately: Option = Option("-experimental-emit-module-separately", .flag, attributes: [.helpHidden, .noInteractive], helpText: "Emit module files as a distinct job (new Driver only)")
  ...
  public static let experimentalMultiStatementClosures: Option = Option("-experimental-multi-statement-closures", .flag, attributes: [.helpHidden, .frontend, .noDriver], helpText: "Enable experimental support for type inference in multi-statement closures")
  ...
  public static let ExperimentalPerformanceAnnotations: Option = Option("-experimental-performance-annotations", .flag, attributes: [.helpHidden, .frontend], helpText: "Perform cross-module optimization")
  ...
  public static let Fsystem: Option = Option("-Fsystem", .separate, attributes: [.frontend, .argumentIsPath, .symbolGraphExtract], helpText: "Add directory to system framework search path")
  ...
  public static let F: Option = Option("-F", .joinedOrSeparate, attributes: [.frontend, .argumentIsPath, .symbolGraphExtract], helpText: "Add directory to framework search path")
  ...
  public static let help: Option = Option("-help", .flag, attributes: [.frontend, .autolinkExtract, .moduleWrap, .indent, .symbolGraphExtract], helpText: "Display available options")
  public static let help_: Option = Option("--help", .flag, alias: Option.help, attributes: [.frontend, .autolinkExtract, .moduleWrap, .indent, .symbolGraphExtract], helpText: "Display available options")
  ...
  public static let includeSpiSymbols: Option = Option("-include-spi-symbols", .flag, attributes: [.helpHidden, .frontend, .noInteractive, .supplementaryOutput, .symbolGraphExtract], helpText: "Add symbols with SPI information to the symbol graph")
  ...
  public static let I: Option = Option("-I", .joinedOrSeparate, attributes: [.frontend, .argumentIsPath, .symbolGraphExtract], helpText: "Add directory to the import search path")
  ...
  public static let L: Option = Option("-L", .joinedOrSeparate, attributes: [.frontend, .doesNotAffectIncrementalBuild, .argumentIsPath, .symbolGraphExtract], helpText: "Add directory to library link search path", group: .linkerOption)
  ...
  public static let minimumAccessLevel: Option = Option("-minimum-access-level", .separate, attributes: [.noDriver, .symbolGraphExtract], metaVar: "<level>", helpText: "Include symbols with this access level or more")
  ...
  public static let moduleCachePath: Option = Option("-module-cache-path", .separate, attributes: [.frontend, .doesNotAffectIncrementalBuild, .argumentIsPath, .symbolGraphExtract], helpText: "Specifies the Clang module cache path")
  ...
  public static let moduleName: Option = Option("-module-name", .separate, attributes: [.frontend, .moduleInterface, .symbolGraphExtract], helpText: "Name of the module to build")
  ...
  public static let noEmitModuleSeparately: Option = Option("-no-emit-module-separately", .flag, attributes: [.helpHidden, .noInteractive], helpText: "Force using merge-module as the incremental build mode (new Driver only)")
  ...
  public static let outputDir: Option = Option("-output-dir", .separate, attributes: [.noDriver, .argumentIsPath, .symbolGraphExtract], metaVar: "<dir>", helpText: "Output directory")
  ...
  public static let prettyPrint: Option = Option("-pretty-print", .flag, attributes: [.symbolGraphExtract], helpText: "Pretty-print the output JSON")
  ...
  public static let resourceDir: Option = Option("-resource-dir", .separate, attributes: [.helpHidden, .frontend, .argumentIsPath, .symbolGraphExtract], metaVar: "</usr/lib/swift>", helpText: "The directory that holds the compiler resource files")
  ...
  public static let sdk: Option = Option("-sdk", .separate, attributes: [.frontend, .argumentIsPath, .symbolGraphExtract], metaVar: "<sdk>", helpText: "Compile against <sdk>")
  ...
  public static let skipInheritedDocs: Option = Option("-skip-inherited-docs", .flag, attributes: [.helpHidden, .frontend, .noInteractive, .supplementaryOutput, .symbolGraphExtract], helpText: "Skip emitting doc comments for members inherited through classes or default implementations")
  public static let skipSynthesizedMembers: Option = Option("-skip-synthesized-members", .flag, attributes: [.noDriver, .symbolGraphExtract], helpText: "Skip members inherited through classes or default implementations")
  ...
  public static let swiftVersion: Option = Option("-swift-version", .separate, attributes: [.frontend, .moduleInterface, .symbolGraphExtract], metaVar: "<vers>", helpText: "Interpret input according to a specific Swift language version number")
  ...
  public static let target: Option = Option("-target", .separate, attributes: [.frontend, .moduleWrap, .moduleInterface, .symbolGraphExtract], metaVar: "<triple>", helpText: "Generate code for the given target <triple>, such as x86_64-apple-macos10.9")
  ...
  public static let v: Option = Option("-v", .flag, attributes: [.doesNotAffectIncrementalBuild, .symbolGraphExtract], helpText: "Show commands to run and use verbose output")
  ...
  public static let Xcc: Option = Option("-Xcc", .separate, attributes: [.frontend, .symbolGraphExtract], metaVar: "<arg>", helpText: "Pass <arg> to the C/C++/Objective-C compiler")
...
extension Option {
  public static var allOptions: [Option] {
    return [
      ...
      Option.experimentalMultiStatementClosures,
