...
extension Option {
  ...
  public static let timeTracePathEQ: Option = Option("-time-trace-path=", .joined, alias: Option.timeTracePath, attributes: [.frontend, .noInteractive, .argumentIsPath, .cacheInvariant])
  public static let timeTracePath: Option = Option("-time-trace-path", .separate, attributes: [.frontend, .noInteractive, .argumentIsPath, .cacheInvariant], metaVar: "<path>", helpText: "Emit time trace output to <path>")
