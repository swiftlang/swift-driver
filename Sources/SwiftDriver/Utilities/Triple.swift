...
extension Triple {
  public var isAppleFirmware: Bool {
    return Self.isAppleFirmware(vendor: vendor, os: os)
  }

  fileprivate static func isAppleFirmware(vendor: Triple.Vendor?, os: Triple.OS?) -> Bool {
  ...
  fileprivate static func isDarwin(vendor: Triple.Vendor?, os: Triple.OS?) -> Bool {
    ...
    return (os?.isDarwin ?? false) || isAppleFirmware(vendor: vendor, os: os)
  }
}
