...
/// Toolchain for `wasm32-unknown-emscripten`. Uses `emcc` (the Emscripten
/// compiler driver) as the linker rather than `wasm-ld` directly.
public final class EmscriptenToolchain: WebAssemblyToolchainProtocol {
