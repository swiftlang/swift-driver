...
@_spi(Testing) public final class SwiftScan {
  ...
  @_spi(Testing) public var supportsSeparateImportOnlyDependencise: Bool {
    return api.swiftscan_swift_textual_detail_get_source_import_module_dependencies != nil
  }
...
private extension swiftscan_functions_t {
  init(_ swiftscan: Loader.Handle) throws {
    ...
    self.swiftscan_swift_textual_detail_get_source_import_module_dependencies =
      loadOptional("swiftscan_swift_textual_detail_get_source_import_module_dependencies")
